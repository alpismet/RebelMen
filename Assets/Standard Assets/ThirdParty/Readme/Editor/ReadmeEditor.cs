...
public class ReadmeEditor : UnityEditor.Editor
{
    ...
    [MenuItem("Window/Show Sample Instructions")]
    ...
    protected override void OnHeaderGUI()
    {
        ...
        {
            GUILayout.Label(readme.icon, GUILayout.Width(iconWidth * 2), GUILayout.Height(iconWidth));
    ...
    void Init()
    {
        ...
        m_TitleStyle.stretchHeight = true;
